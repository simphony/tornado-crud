...
class ResourceHandler:
    ...
    @gen.coroutine
    def create(self, instance, args=None):
    ...
    @gen.coroutine
    def retrieve(self, instance, args=None):
    ...
    @gen.coroutine
    def update(self, instance, args=None):
    ...
    @gen.coroutine
    def delete(self, instance, args=None):
    ...
    @gen.coroutine
    def exists(self, instance, args=None):
